...
menubar.on('ready', () => {
  baseRecipe = fs.readFileSync('recipes.json').toString()
...
//    menubar.window.webContents.send('load', {})
...
//  console.log(data)
  // add a function that maps through our json file and writes new values to that
//  console.log(baseRecipe.all_recipes)
  //const updatedRecipes = baseRecipe.all_recipes.push(data)
//  fs.writeFileSync(allRecipes, JSON.stringify(updatedRecipes, null, 2))
})
