...
const renderRecipes = (recipes) => {
  JSON.parse(recipes).all_recipes.map(recipe => $('#recipe-box').append(`<p>${recipe.title}</p><a href="${recipe.link}">link</a>`))
}
...
$('#save-grocery-list-btn').on('click', (groceryHtml) => {
  groceryHtml = $('#grocery-list-view')
  saveGroceryList(groceryHtml)
})
