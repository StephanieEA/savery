...
const showRecipe = (title, link) => {
  $('#recipe-box').append(`
    <button class="recipe-title">${title}</button><input type="checkbox" id=${title}><label for="delete"> delete</label>
...
const renderRecipes = (recipes) => {
  JSON.parse(recipes).all_recipes.map(recipe => $('#recipe-box').append(`
    <button class="recipe-title">${recipe.title}</button><input type="checkbox" id=${recipe.title}><label for=${recipe.title}> delete</label>
