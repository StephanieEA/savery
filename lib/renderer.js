...
const showRecipe = (title, link) => {
  $('#recipe-box').append(`
    ...
    <webview id="${title}" src="${link}" style="display:inline-flex; width:640px; height:480px"></webview>
  `)
}
...
const renderRecipes = (recipes) => {
  ...
  <webview id="${recipe.title}" src="${recipe.link}" style="display:inline-flex; width:640px; height:480px"></webview>`))
}
